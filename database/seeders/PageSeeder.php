    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'meta_title' => ['ru' => 'Руководство — УЗЕКС', 'uz' => 'Rahbariyat — UZEX', 'en' => 'Management — UZEX'],
                'meta_description' => ['ru' => 'Руководство и структура управления УЗЕКС', 'uz' => 'UZEX rahbariyati va boshqaruv tuzilmasi', 'en' => 'UZEX management and governance structure'],
                'is_published' => true,
                'sort_order' => 2,
            ],
            [
            ...
            [
                ...
                'meta_title' => ['ru' => 'Контакты — УЗЕКС', 'uz' => 'Kontaktlar — UZEX', 'en' => 'Contacts — UZEX'],
